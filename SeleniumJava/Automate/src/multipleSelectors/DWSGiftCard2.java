...
public class DWSGiftCard2 {
    ...
    private static void fillBuyingDetails(ChromeDriver driver) {
        WebElement form = driver.findElement(By.className("giftcard"));
        List<WebElement> fields = form.findElements(By.tagName("input"));
        String[] data = {"fakeRecipient", "recipient@xyz.com", "Fake Sender Name", "sender@abc.com"};
        int indx = 0;
        for (WebElement field : fields) {
            field.sendKeys(data[indx++]);
        }
    }
}